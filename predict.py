...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------#
    video_path      = "D:/deep learning 2/YOLOV3-tf2/yolo3-tf2-main/video/break_red.mp4"
    #video_path      = 0
    video_save_path = "D:/deep learning 2/YOLOV3-tf2/yolo3-tf2-main/video/break_red(save).mp4"
    video_fps       = 25.0
    #-------------------------------------------------------------------------#
